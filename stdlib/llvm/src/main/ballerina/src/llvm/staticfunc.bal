...
////public function llvmTargetMachineEmitToFile(LLVMTargetMachineRef t, LLVMModuleRef m, BytePointer filename, int jvmcodegen, BytePointer errorMessage) returns int = external;
...
////public function llvmTargetMachineEmitToFile(LLVMTargetMachineRef t, LLVMModuleRef m, ByteBuffer filename, int jvmcodegen, ByteBuffer errorMessage) returns int = external;
////public function llvmTargetMachineEmitToFile(LLVMTargetMachineRef t, LLVMModuleRef m, BytePointer filename, int jvmcodegen, PointerPointer errorMessage) returns int = external;
////public function llvmTargetMachineEmitToMemoryBuffer0(LLVMTargetMachineRef t, LLVMModuleRef m, int jvmcodegen, byte[] errorMessage, LLVMMemoryBufferRef outMemBuf) returns int = external;
////public function llvmTargetMachineEmitToMemoryBuffer(LLVMTargetMachineRef t, LLVMModuleRef m, int jvmcodegen, BytePointer errorMessage, PointerPointer outMemBuf) returns int = external;
////public function llvmTargetMachineEmitToMemoryBuffer(LLVMTargetMachineRef t, LLVMModuleRef m, int jvmcodegen, ByteBuffer errorMessage, LLVMMemoryBufferRef outMemBuf) returns int = external;
////public function llvmTargetMachineEmitToMemoryBuffer1(LLVMTargetMachineRef t, LLVMModuleRef m, int jvmcodegen, byte[] errorMessage, PointerPointer outMemBuf) returns int = external;
//public function llvmTargetMachineEmitToMemoryBuffer2(LLVMTargetMachineRef t, LLVMModuleRef m, int jvmcodegen, PointerPointer errorMessage, LLVMMemoryBufferRef outMemBuf) returns int = external;
////public function llvmTargetMachineEmitToMemoryBuffer(LLVMTargetMachineRef t, LLVMModuleRef m, int jvmcodegen, BytePointer errorMessage, LLVMMemoryBufferRef outMemBuf) returns int = external;
////public function llvmTargetMachineEmitToMemoryBuffer(LLVMTargetMachineRef t, LLVMModuleRef m, int jvmcodegen, ByteBuffer errorMessage, PointerPointer outMemBuf) returns int = external;
