...
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.generatePackage;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.intiPackageGen;
...
public class JvmCodeGenerator implements CodeGenerator {
    ...
    private static final CompilerContext.Key<JvmCodeGenerator> CODE_GEN = new CompilerContext.Key<>();
    ...
    private JvmCodeGenerator(CompilerContext context) {
    ...
    public static JvmCodeGenerator getInstance(CompilerContext context) {

        JvmCodeGenerator codeGenerator = context.get(CODE_GEN);
        if (codeGenerator == null) {
            codeGenerator = new JvmCodeGenerator(context);
        }
