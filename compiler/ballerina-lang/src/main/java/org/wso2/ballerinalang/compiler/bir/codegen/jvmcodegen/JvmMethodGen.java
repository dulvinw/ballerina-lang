 ...
 *  under the License.
 */
package org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen;
...
import org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmErrorGen.ErrorHandlerGenerator;
import org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmInstructionGen.InstructionGenerator;
import org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmLabelGen.LabelGenerator;
import org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmTerminatorGen.TerminatorGenerator;
import org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.interop.JType;
import org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.interop.JTypeTags;
...
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.ANNOTATION_MAP_NAME;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.ANNOTATION_UTILS;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.ARGUMENT_PARSER;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.ARRAY_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.BALLERINA;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.BAL_ERRORS;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.BAL_EXTENSION;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.BTYPE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.BUILT_IN_PACKAGE_NAME;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.CHANNEL_DETAILS;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.COMPATIBILITY_CHECKER;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.CURRENT_MODULE_INIT;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.DECIMAL_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.DEFAULTABLE_ARGS_ANOT_FIELD;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.DEFAULTABLE_ARGS_ANOT_NAME;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.ERROR_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.FUNCTION;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.FUNCTION_POINTER;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.FUTURE_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.HANDLE_RETURNED_ERROR_METHOD;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.HANDLE_STOP_PANIC_METHOD;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.HANDLE_THROWABLE_METHOD;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.HANDLE_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.JAVA_PACKAGE_SEPERATOR;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.JAVA_RUNTIME;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.JAVA_THREAD;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.LAUNCH_UTILS;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.MAP_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.MODULE_INIT;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.MODULE_INIT_CLASS_NAME;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.MODULE_START;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.MODULE_STOP;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.OBJECT;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.OBJECT_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.PANIC_FIELD;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.RUNTIME_UTILS;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.SCHEDULER;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.SCHEDULER_START_METHOD;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.SCHEDULE_FUNCTION_METHOD;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.STRAND;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.STREAM_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.STRING_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.THROWABLE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.TYPEDESC_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.VALUE_CREATOR;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.WINDOWS_PATH_SEPERATOR;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmConstants.XML_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmInstructionGen.B_STRING_VALUE;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmInstructionGen.InstructionGenerator.visitInvokeDyn;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmInstructionGen.addBoxInsn;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmInstructionGen.addUnboxInsn;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmInstructionGen.isBString;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmObservabilityGen.emitReportErrorInvocation;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmObservabilityGen.emitStartObservationInvocation;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmObservabilityGen.emitStopObservationInvocation;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmObservabilityGen.getFullQualifiedRemoteFunctionName;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.JavaClass;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.birFunctionMap;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.currentClass;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.getFunctionWrapper;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.getModuleLevelClassName;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.getPackageName;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.lookupGlobalVarClassName;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.packageToModuleId;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmPackageGen.symbolTable;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmTerminatorGen.TerminatorGenerator.toNameString;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmTerminatorGen.cleanupObjectTypeName;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmTerminatorGen.isExternStaticFunctionCall;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmTerminatorGen.loadChannelDetails;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmTypeGen.loadLocalType;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmTypeGen.loadType;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.JvmTypeGen.typeOwnerClass;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.interop.ExternalMethodGen.genJMethodForBExternalFunc;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.interop.ExternalMethodGen.isBallerinaBuiltinModule;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.interop.InteropMethodGen.JInstruction;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.interop.InteropMethodGen.getJTypeSignature;
import static org.wso2.ballerinalang.compiler.bir.codegen.jvmcodegen.interop.InteropMethodGen.getSignatureForJType;
    ...
    static void generateLambdaMethod(BIRInstruction ins, ClassWriter cw, String lambdaName) {
        ...
        if (isVirtual) {
            ...
            if (functionWrapper != null) {
                ...
                BPackageSymbol symbol = JvmCodeGenerator.packageCache.getSymbol(orgName + "/" + moduleName);
